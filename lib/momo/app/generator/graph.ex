defmodule Momo.App.Generator.Graph do
  @moduledoc false
  @behaviour Diesel.Generator

  @impl true
  def generate(app, _) do
    graph = Graph.new()

    graph =
      Enum.reduce(app.models, graph, fn model, g ->
        g
        |> with_model(model)
  ...
  defp diagram_function(app, graph) do
