defmodule Momo.Model.Parser do
  @moduledoc false
  ...
  alias Momo.Model.Key
  alias Momo.Model.Relation
  alias Momo.Model.Action
  alias Momo.Model.OnConflict
  alias Momo.Model.Policy
  ...
  defp action_tasks({:task, [name: nil, if: nil], [module]}),
    do: %Momo.Model.Task{module: module}

  defp action_tasks({:task, [name: module, if: nil], _}), do: %Momo.Model.Task{module: module}

  defp action_tasks({:task, [name: module, if: condition], _}),
    do: %Momo.Model.Task{module: module, if: condition}

  defp action_tasks({:on, conditions, modules}) do
    for module <- modules do
      %Momo.Model.Task{module: module, if: conditions}
    end
  end
