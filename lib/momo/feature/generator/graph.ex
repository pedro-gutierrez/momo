defmodule Momo.Feature.Generator.Graph do
  @moduledoc false
  ...
  def generate(feature, _) do
    ...
    graph =
      Enum.reduce(feature.models, graph, fn model, g ->
        g
        |> with_model(model)
    ...
    [
      ...
      get_paths_function(),
      diagram_function(feature, graph),
  ...
  defp diagram_function(feature, graph) do
